...
public class DriveSwerve2 extends CommandBase {
  ...
  public DriveSwerve2(SwerveDrive m_swerveDrive, Supplier<Double> x, Supplier<Double> y, Supplier<Double> rot, Supplier<Boolean> fieldRelative) {
